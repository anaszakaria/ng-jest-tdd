...
describe('AppComponent', () => {
  ...
  describe('Routing', () => {
    ...
    it('navigates to user page when clicking the username on user list', fakeAsync(
      async () => {
        ...
        fixture.detectChanges();
        const linkToUserPage = fixture.nativeElement.querySelector('.list-group-item') as HTMLAnchorElement;
